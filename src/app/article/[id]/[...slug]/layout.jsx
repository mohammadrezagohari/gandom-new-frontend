      ...
      <aside className="hidden lg:flex flex-col lg:sticky lg:top-0 lg:left-0 col-span-12 lg:col-span-4  lg:p-6 ">
        <div className=" relative w-full h-[67vh] rounded-xl lg:mb-12 ">
          ...
          <div className=" flex items-end justify-start absolute top-0 left-0 right-0 bottom-0 bg-g4c bg-opacity-[50%] rounded-xl">
            <h4 className=" w-full text-center absolute top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%] text-gf lg:text-[2.8125vw] text-[1.7rem]  font-Holispay">
              Lorem ipsum Lorem{" "}
            </h4>
            <div className="flex items-center justify-start gap-1 p-5 lg:p-7 ">
              <span className=" text-gDarkYellow lg:text-[1.25vw] text-base  font-PoppinsRegular ">
                21 July 2023
              </span>
              <span className=" text-gf lg:text-[1.25vw] text-base  font-PoppinsRegular">
                /
              </span>
              <span className=" text-gf lg:text-[1.25vw] text-base  font-PoppinsRegular">
                20 minutes
        ...
        <div className="hidden lg:block p-5 w-full border-[1.5px] border-ge4 bg-gec rounded-xl ">
          <h4 className=" w-full pb-3 lg:pb-[0.78125vw] border-b-[1px] border-gd5 text-g4c lg:text-[2.3vw] text-[1.7rem]  font-Holispay">
            Lorem ipsum Lorem{" "}
          </h4>
