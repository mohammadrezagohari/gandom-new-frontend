...
import PictureBox from "@/src/components/common/picture-box-weblog";
    ...
    <div className="recentArticleBox grid grid-cols-12 lg:grid-cols-12 gap-5 lg:gap-0">
      <div className="pictureBox col-span-12 lg:col-span-6">
        ...
        <PictureBox
          ...
          circleSmYellow=""
          circleClasses="bg-gf"
          classes={`bg-[url(/wimg.png)] rounded-l-lg rounded-r-lg lg:rounded-l-0 lg:rounded-r-lg w-[87%] lg:w-[88%] lg:h-[21.549479166666668vw] h-[13.188rem]`}
        />
      </div>
      <div className="textBox col-span-12 lg:col-span-6 flex flex-col items-start justify-center gap-2 lg:gap-[1.0416666666666667vw]">
        <div className="divide-x divide-gb8">
          <span className="pe-2 lg:px-2 text-[0.95rem] lg:text-[1.25vw] lg:leading-[2.0833333333333335vw] font-PoppinsRegular text-gDarkYellow">
            {author}
          </span>
          <span className="px-2 text-[0.95rem] lg:text-[1.25vw] lg:leading-[2.0833333333333335vw] font-PoppinsRegular text-gb8">
            {date}
          </span>
        </div>
        <Link href={href}>
