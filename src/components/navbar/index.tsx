...
function Navbar() {
    ...
    return (
        <nav
            className={`w-full  ${pathname == `/${localActive}` ||
        ...
        >
            <div className="relative transition ease-in-out delay-150 container max-w-none pt-[1.5%]">
                <div
                    style={{ zIndex: "5" }}
                    className={`relative flex justify-between py-5 items-center border-b-[1.5px]  ${pathname == `/${localActive}` ||
                ...
                >
                    <button onClick={openLangList}>
                        <CgMenuLeft
                            className={` ${pathname == `/${localActive}` ||
                                pathname == "/service/seo" ||
                                pathname == "/about-us"
                                ? "text-gf"
                                : "text-g21"
                ...
                <div
                    className={`transition-all  ${fade ? "opacity-100 visible" : "opacity-0 invisible"
                        }  overflow-y-scroll lg:overflow-hidden transition ease-in-out fixed z-40 top-[0] bottom-0 left-0 right-0  ${pathname == `/${localActive}` ||
                            pathname == "/service/seo" ||
                            pathname == "/about-us"
                            ? "bg-g21"
                            : "bg-gf"
                ...
                >
                    ...
                    >
                        <div
                            className={` flex justify-between  items-center pb-5 lg:pb-[1.3020833333333333vw] border-b-[1.5px]  ${pathname == `/${localActive}` ||
                                pathname == "/service/seo" ||
                                pathname == "/about-us"
                                ? "border-gec"
                                : "border-g70"
