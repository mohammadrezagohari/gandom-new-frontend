      ...
      <div className=" w-full !min-h-[19.4375vw] font-PoppinsSemiBold col-span-12 lg:col-span-8 ">
        ...
        >
          {reasons.map((item, i) => (
            ...
            >
              <CardBox
                parentClasses="!h-full !w-full border-g70 gap-5 lg:gap-[1.3020833333333333vw] p-5 py-8 lg:p-[1.5625vw] lg:py-[2.34375vw] lg:w-auto"
                circleClasses="w-[6rem] h-[6rem] lg:w-[6.25vw] lg:h-[6.25vw] bg-gYellow text-3xl"
                titleClasses="text-g21 text-2xl lg:text-[1.6vw]  text-justify font-Holispay"
                descClasses="text-g8 text-justify text-base tracking-wide leading-7 lg:text-[0.88125vw] lg:leading-[1.5vw] text-justify font-PoppinsLight line-clamp-5"
                icon={item.svg}
                title={item.title}
                desc={item.desc}
              />
