  ...
  return (
    <section className="w-full py-8 lg:py-[3.125vw]">
      ...
      >
        ...
        >
          <Link href={`/service/5/content-generate`}>
        ...
        >
          <PictureBox
            href={`/service/5/content-generate`}
            ...
            circleClasses="bg-gf"
            classes="bg-[url(/img/s_5.jpg)] rounded-l-lg rounded-r-lg lg:rounded-l-0 lg:rounded-r-lg w-full lg:w-[88%] lg:h-[30.92vw] h-[13.188rem]"
          />
        </div>
      </div>
