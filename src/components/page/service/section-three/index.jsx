      ...
      >
        ...
        >
          <SectionCounter
            ...
            lineHeight="bg-gec h-[64%] lg:h-[56%]"
        ...
        >
          <Link href={`/${locale}/service/3/graphic-design`}>
            <SectionTitle classes="text-gec" title={t("items.2.title")} />
          </Link>
        ...
        >
          <PictureBox
            ...
            classes="bg-[url(/img/s_4.jpg)] rounded-l-lg rounded-r-lg lg:rounded-l-0 lg:rounded-r-lg w-full lg:w-[88%] lg:h-[30.92vw] h-[13.188rem]"
          />
        </div>
      </div>
