...
function SpecializeSection() {
  const specializeItems = [
    ...
    },
    {
      ...
      desc: "Sell your goods online or promote your loyalty programs with our e-stores and customers’ personal accounts.",
    },
    {
      id: 3,
      title: "Marketplace",
      desc: "Realize your idea of creating a platform to unite different sellers and buyers in one place with us.",
    },
    {
      id: 4,
      title: "Software As a Service (SaaS)",
      desc: "Launch your new uber-type on-demand startup with our web development services. We will help you develop and boost the idea.",
    },
    {
      id: 5,
    ...
    },
    {
      id: 6,
      title: "Other",
      desc: "Turn any of your startup ideas into reality with us.",
    },
  ];
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:my-2">
          {specializeItems.map((item, i) => (
            <SpecializeCard
              ...
              title={item.title}
              desc={item.desc}
              classes="col-span-1 md:col-span-1 lg:col-span-1"
            />
          ))}
        </div>
      </div>
