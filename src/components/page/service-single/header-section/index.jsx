...
import FilledButton from "@/src/components/common/buttons/filled";
import FilledYellowButton from "@/src/components/common/buttons/fillYellow";
import Image from "next/image";
import ServiceSinglePictureBox from "@/src/components/common/service-single-picture-box";

function HeaderSection({ sectionId = 1 }) {
  return (
        ...
        <div className="col-span-1 lg:col-span-7 order-2 lg:order-1">
          <div className="">
            <ServiceSinglePictureBox
              ...
              classes="bg-[url(/wimg.png)] rounded-l-lg rounded-r-lg lg:rounded-l-0 lg:rounded-r-lg w-full lg:w-[85%] "
            />
