...
export const translateStaticServiceText: ILanguagesTranslateStaticServiceText =
  {
    en: {
      title: "Our services",
      context:
        "Explore our comprehensive suite of services, from innovative UI/UX design to responsive web and mobile solutions, expert SEO, captivating graphic design, and streamlined software solutions:",
    },
    fa: {
      title: "خدمات ما",
      context:
        "مجموعه کامل خدمات ما را کشف کنید، از طراحی نوآورانه UI/UX گرفته تا راه‌حل‌های واکنش‌گرا وب و موبایل، سئو تخصصی، طراحی گرافیک جذاب، و راه‌حل‌های نرم‌افزاری بهینه شده:",
    },
  };
  ...
  fa: [
    {
      ...
      link: "service/4/web-development",
    },
    {
      id: 2,
      number: "02",
      ...
      link: "service/6/mobile-application",
    },
    {
      id: 3,
      number: "03",
      ...
      link: "service/2/search-engine-optimization",
    },
    {
      id: 4,
      number: "04",
    ...
    },
    {
      ...
      link: "service/1/software-development",
    },
  ],
  en: [
    {
