    ...
    <>
      <div className="container h-full col-span-4">
        <div className="flex flex-col justify-center gap-5 lg:gap-[1.3020833333333333vw] h-full">
          ...
          <p className="text-g8 lg:text-[1.3vw] lg:leading-[2.34375vw] text-justify text-base leading-6 font-PoppinsLight pb-6">
            Explore our comprehensive suite of services, from innovative UI/UX
            design to responsive web and mobile solutions, expert SEO,
          ...
          {service.map((item, i) => (
            ...
            >
              ...
              <div className=" !flex !flex-col !justify-between !items-start !gap-10 ">
                ...
                <h4 className="lg:text-[3.2552083333333335vw] lg:leading-[1.8313802083333333vw] text-[30px] leading-[33.9px] font-Holispay ">
                  {item.title}
                </h4>
                <h3 className="text-gDarkYellow lg:text-[1.171875vw] lg:leading-[1.8313802083333333vw] text-[12px] leading-[14.06px] font-PoppinsLight ">
                  {item.shortDesc}
                </h3>
              </div>
