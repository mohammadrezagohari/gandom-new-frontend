...
function TeamSection() {
  ...
  const gridItems = [
    ...
    {
      id: 2,
      parentClasses: "bg-g21 overflow-hidden inline-block rounded-tr-[50%] lg:rounded-none ",
      hoverClasses: "",
    ...
    {
      id: 3,
      parentClasses: "bg-gYellow rounded-tr-[50%] overflow-hidden hidden lg:inline-block",
      hoverClasses: "",
    ...
    {
      id: 5,
      parentClasses: "bg-gYellow overflow-hidden inline-block rounded-b-full lg:rounded-none",
      hoverClasses: "",
    ...
    {
      id: 6,
      parentClasses: "bg-g21 rounded-br-[50%] overflow-hidden hidden lg:inline-block",
      hoverClasses: "",
      position: "Frontend Developer",
      name: "Alireza Khalili",
      img: "/webp/GT_AKH.png",
    },
  ];
  return (
