...
function CoommentBox() {
  ...
  return (
    <div className="border-[1px] border-gb9 border-opacity-[20%]  p-5 rounded-xl ">
      <div className="flex items-center justify-start">
        <div className="flex items-center justify-center">
          {/* <div className="w-[3rem] h-[3rem] rounded-full bg-[#BCBCBC80]"></div> */}
          <div className="w-[2.8rem] h-[2.8rem] flex items-center justify-center rounded-full bg-[#BCBCBC80] ">
            <PiUserLight className="text-g75 text-lg" />
          </div>
          <div className="mx-2 h-[2.8rem] w-[3px] bg-gDarkYellow rounded-full  "></div>
          <div className="">
            <span
              className={`block text-g4c lg:text-[1rem] text-start  text-[1rem]  font-Holispay`}
            >
              Ali Asadpour
            ...
            <span
              className={`block text-g8 lg:text-[1rem] text-start  text-[1rem]  font-Holispay`}
            >
              20 July 2023
              {/* We are a leader in the field of web and mobile software services */}
            </span>
      ...
      <p className="text-g8 lg:text-[0.85rem] leading-5 text-base  font-PoppinsLight py-4">
