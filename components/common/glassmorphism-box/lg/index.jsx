...
function GlassmorphismBox({title,desc}) {
  return (
    <div>
      <div className="glassBox w-[278.92px] min-h-[160.01px] lg:w-[573.5px] lg:h-[366px]  p-4 pb-[15%] lg:p-7 rounded-md relative">
          <h3 className="text-gf mb-[1%] lg:mb-[5%] lg:text-[32px] lg:leading-[36.16px] text-xl leading-[40.68px] font-Holispay ">{title}</h3>
          <p className="text-gf text-justify lg:text-[18px] lg:leading-[27px] text-[14px] leading-[21px] font-PoppinsLight ">{desc}</p>
